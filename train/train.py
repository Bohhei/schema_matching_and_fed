...
def main():
    ...
    'nom':{
        'train': './datasets/omap/train_nominal.xlsx',
        'val': './datasets/omap/val_nominal.xlsx',
           'test': './datasets/omap/test_nominal.xlsx'
        },
    'num':{
        'train': './datasets/omap/train_numeric.xlsx',
        'val': './datasets/omap/val_numeric.xlsx',
           'test': './datasets/omap/test_numeric.xlsx'
        },
    'mimic':{
