...
class AOA_7(nn.Module):
    def __init__(self, embedding_matrix, opt):
        super(AOA_7, self).__init__()
        self.opt = opt
        self.fc_dim = 512
        ...
        self.lin1_c = nn.Linear(30, 64)#nn.Linear(int(self.opt.constr_dim), 64)
    ...
    def forward(self, inputs):
        ...
        #constraints_2 = torch.concatenate((constraints[:,-4:],constraints[:,1:2]), axis=1)
        #constraints = torch.concatenate((constraints_2, constraints[:,15:16]), axis=1)
